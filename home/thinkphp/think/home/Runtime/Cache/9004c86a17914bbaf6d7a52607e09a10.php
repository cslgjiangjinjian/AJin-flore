...
<!--正文-->
	<div class="works_contents">
		...
		<div class="works_lists">
			<?php if(is_array($worklist)): $i = 0; $__LIST__ = $worklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="works_posts">
					<img src="__TMPL__/Public/images/works/<?php echo ($vo['imgurl']); ?>">
